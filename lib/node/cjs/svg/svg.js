...
const characterWidth_js_1 = require("./characterWidth.js");
const svg_engine_1 = require("svg-engine");
...
class SVG_ {
    constructor(data, options) {
        ...
        //-- Create SVG
        this.instance = new svg_engine_1.SVG();
    ...
    _render() {
        ...
        const scissorsSVG = this.instance.addSVG("11px", "19px").x((0, svg_engine_1.calc)("62mm - 5.25px")).y("30pt");
        ...
        receiptTextContainer.addTSpan(translations_js_1.default[this._language].receipt)
            .x(0)
            .y(0)
            .dy("11pt")
            .fontFamily("Arial")
            ...
            .fontSize("11pt");
        //-- Creditor
        receiptTextContainer.addTSpan(translations_js_1.default[this._language].account)
            .x(0)
            .y("7mm")
            .dy("9pt")
            .fontFamily("Arial")
        ...
        if (this._data.reference !== undefined) {
            receiptTextContainer.addTSpan(translations_js_1.default[this._language].reference)
                .x(0)
                .dy("18pt")
                .fontFamily("Arial")
                .fontWeight("bold")
        ...
        if (this._data.debtor !== undefined) {
            ...
            receiptTextContainer.addTSpan(translations_js_1.default[this._language].payableBy)
                .x(0)
                .dy("18pt")
                .fontFamily("Arial")
                .fontWeight("bold")
        ...
        const amountContainer = receiptContainer.addText()
            .y("63mm");
        amountContainer.addTSpan(translations_js_1.default[this._language].currency)
            .x(0)
            .dy("6pt")
            .fontFamily("Arial")
            .fontWeight("bold")
        ...
        //-- Acceptance point
        amountContainer.addTSpan(translations_js_1.default[this._language].acceptancePoint)
            .x("52mm")
            .y("82mm")
            .textAlign("right")
            .fontFamily("Arial")
        ...
        const paymentPartContainer = this.instance.addSVG()
            .x("67mm")
            .y("5mm");
        paymentPartContainer.addText(translations_js_1.default[this._language].paymentPart)
            .x(0)
            .y(0)
            .dy("11pt")
            .fontFamily("Arial")
        ...
        const paymentPartMiddleTextContainer = paymentPartContainer.addText()
            .y("63mm");
        paymentPartMiddleTextContainer.addTSpan(translations_js_1.default[this._language].currency)
            .x(0)
            .dy("8pt")
            .fontFamily("Arial")
            .fontWeight("bold")
        ...
        if (this._data.amount !== undefined) {
            ...
            this._addRectangle(78, (0, svg_engine_1.calc)("68mm + 8pt + 5pt", "mm"), 40, 15);
        }
        //-- AV1 and AV2
        ...
        //-- Creditor
        paymentPartRightTextContainer.addTSpan(translations_js_1.default[this._language].account)
            .x(0)
            .y(0)
            .dy("11pt")
            .fontFamily("Arial")
        ...
        //-- Reference
        if (this._data.reference !== undefined) {
            paymentPartRightTextContainer.addTSpan(translations_js_1.default[this._language].reference)
                .x(0)
                .dy("22pt")
                .fontFamily("Arial")
                .fontWeight("bold")
        ...
        if (this._data.message !== undefined || this._data.additionalInformation !== undefined) {
            paymentPartRightTextContainer.addTSpan(translations_js_1.default[this._language].additionalInformation)
                .x(0)
                .dy("22pt")
                .fontFamily("Arial")
                .fontWeight("bold")
        ...
        if (this._data.debtor !== undefined) {
            const formattedDebtorAddress = this._formatAddress(this._data.debtor);
            paymentPartRightTextContainer.addTSpan(translations_js_1.default[this._language].payableBy)
                .x(0)
                .dy("22pt")
                .fontFamily("Arial")
                .fontWeight("bold")
            ...
            paymentPartRightTextContainer.addTSpan(translations_js_1.default[this._language].payableByName)
                .x(0)
                .dy("22pt")
                .fontFamily("Arial")
                .fontWeight("bold")
    ...
    _renderQRCode() {
        const qrcode = (0, qr_code_js_1.default)(this._data, "svg", utils.mm2px(46));
    ...
    _getLineCountOfText(text, lengthInPixel, size) {
        if (text === undefined) {
            ...
            let lines = 0;
            let remainder = (0, characterWidth_js_1.calculateTextWidth)(text, size);
            while (remainder > 1) {
                lines++;
    ...
    _fitTextToWidth(text, lengthInPixel, maxLines, size) {
        ...
        const checkCurrentLine = (currentLine) => {
            const lines = [];
            let leftover = "";
            if ((0, characterWidth_js_1.calculateTextWidth)(currentLine, size) > lengthInPixel) {
                const currentWordRemainder = currentLine.split("");
                let currentWord = "";
                while (currentWordRemainder.length > 0) {
                    if ((0, characterWidth_js_1.calculateTextWidth)(currentWord, size) <= lengthInPixel) {
        ...
        while (remainder.length > 0) {
            ...
            if ((0, characterWidth_js_1.calculateTextWidth)(currentLine + nextWord + separator, size) <= lengthInPixel) {
    ...
    _ellipsis(text, lengthInPixel, size) {
        let result = "";
        if ((0, characterWidth_js_1.calculateTextWidth)(text, size) > lengthInPixel) {
            for (let c = 0; c < text.length; c++) {
                if ((0, characterWidth_js_1.calculateTextWidth)(result + text[c] + "...", size) <= lengthInPixel) {
                    result += text[c];
                }
                else {
                    break;

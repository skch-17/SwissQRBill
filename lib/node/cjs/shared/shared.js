...
exports.validateData = exports.removeLinebreaks = exports.cleanData = void 0;
...
function validateData(data) {
    ...
    if ((0, utils_js_1.isIBANValid)(data.creditor.account) === false) {
    ...
    //-- Validate reference
    if ((0, utils_js_1.isQRIBAN)(data.creditor.account)) {
        if (data.reference === undefined) {
            throw new Error("If there is no reference, a conventional IBAN must be used.");
        }
        if ((0, utils_js_1.isQRReference)(data.reference)) {
            if (!(0, utils_js_1.isQRReferenceValid)(data.reference)) {
